...
var Student = function (_Person) {
    ...
    _createClass(Student, [{
        ...
        value: function getDescription() {
            ...
            if (this.hasMajor()) {
                // aca nos devuelve verdadero o falso gracias a la !!
...
var Traveler = function (_Person2) {
    ...
    _createClass(Traveler, [{
        key: 'getGretting',
        value: function getGretting() {
            var location = _get(Traveler.prototype.__proto__ || Object.getPrototypeOf(Traveler.prototype), 'getGretting', this).call(this);
